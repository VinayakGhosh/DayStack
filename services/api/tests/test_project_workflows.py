...
class ProjectWorkflowTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        for table in (Users.__table__, Projects.__table__, ProjectStatus.__table__, Tasks.__table__, TaskStatusHistory.__table__, Labels.__table__, TaskLabels.__table__, Subtasks.__table__, TodaySelections.__table__, Attachments.__table__, AttachmentCleanupJobs.__table__):
            table.create(engine)
