...
class TaskWorkspaceRepository(Protocol):
    ...
    def create_attachment(self, member_id: UUID, task_id: UUID, attachment_id: UUID, filename: str, media_type: str, byte_size: int, storage_key: str): ...

    def finalize_attachment(self, member_id: UUID, task_id: UUID, attachment_id: UUID): ...

    def list_attachments(self, member_id: UUID, task_id: UUID): ...

    def attachment_for_download(self, member_id: UUID, task_id: UUID, attachment_id: UUID): ...

    def delete_attachment(self, member_id: UUID, task_id: UUID, attachment_id: UUID): ...

    def attachment_keys_for_task(self, member_id: UUID, task_id: UUID): ...

    def attachment_keys_for_project(self, member_id: UUID, project_id: UUID): ...

    def queue_attachment_cleanup(self, storage_key: str): ...

    def pending_attachment_cleanup(self): ...

    def complete_attachment_cleanup(self, cleanup_id: UUID): ...

    def failed_attachment_cleanup(self, cleanup_id: UUID): ...
