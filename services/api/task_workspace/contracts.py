...
class TaskWorkspaceRepository(Protocol):
    ...
    def create_task(self, member_id: UUID, project_id: UUID, name: str, description: str | None, due_date=None, priority: str = "none", label_ids: list[UUID] | None = None, subtasks: list[dict] | None = None, label_names: list[str] | None = None): ...

    def update_task(self, member_id: UUID, task_id: UUID, name: str | None, description: str | None, due_date=None, priority: str | None = None, label_ids: list[UUID] | None = None, subtasks: list[dict] | None = None, updated_fields: set[str] | None = None, label_names: list[str] | None = None): ...
    ...
    def create_attachment(self, member_id: UUID, task_id: UUID, attachment_id: UUID, filename: str, media_type: str, byte_size: int, content: bytes): ...
    ...
    def attachment_blob_for_download(self, member_id: UUID, task_id: UUID, attachment_id: UUID): ...
